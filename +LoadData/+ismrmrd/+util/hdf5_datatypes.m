...
% do this.
    ...
    methods
        ...
        function obj = hdf5_datatypes()
            obj.T_float = LoadData.ismrmrd.util.hdf5_datatypes.getType_float();
            obj.T_double = LoadData.ismrmrd.util.hdf5_datatypes.getType_double();
            obj.T_char = LoadData.ismrmrd.util.hdf5_datatypes.getType_char();
            obj.T_complexfloat = LoadData.ismrmrd.util.hdf5_datatypes.getType_complexfloat();
            obj.T_complexdouble = LoadData.ismrmrd.util.hdf5_datatypes.getType_complexdouble();
            obj.T_ushort = LoadData.ismrmrd.util.hdf5_datatypes.getType_ushort();
            obj.T_EncodingCounters = LoadData.ismrmrd.util.hdf5_datatypes.getType_EncodingCounters();
            obj.T_AcquisitionHeader = LoadData.ismrmrd.util.hdf5_datatypes.getType_AcquisitionHeader();
            obj.T_Acquisition = LoadData.ismrmrd.util.hdf5_datatypes.getType_Acquisition();
            obj.T_Waveform = LoadData.ismrmrd.util.hdf5_datatypes.getType_Waveform();
            obj.T_WaveformHeader = LoadData.ismrmrd.util.hdf5_datatypes.getType_WaveformHeader();
        end
    ...
    methods (Static)
        ...
        function b = getType_AcquisitionHeader()
            ...
            H5T.insert(b, 'idx', 242, LoadData.ismrmrd.util.hdf5_datatypes.getType_EncodingCounters);
        ...
        function b = getType_Acquisition()
            ...
            head = H5T.copy(LoadData.ismrmrd.util.hdf5_datatypes.getType_AcquisitionHeader());
            traj = H5T.vlen_create(LoadData.ismrmrd.util.hdf5_datatypes.getType_float());
            data = H5T.vlen_create(LoadData.ismrmrd.util.hdf5_datatypes.getType_float());
        ...
        function b = getType_Waveform()
            ...
            head = H5T.copy(LoadData.ismrmrd.util.hdf5_datatypes.getType_WaveformHeader());
