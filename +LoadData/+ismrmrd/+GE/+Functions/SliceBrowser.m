...
if length(varargin)>1
    ...
    if length(clims)==2
        ...
        warning('input 2 = caxis -> should be length==2; ignoring');
    end
end
% --- rfs ---
...
% +++ rfs +++
% adding caxis as input
if isfield(handles,'clims'), clims = handles.clims; end
% --- rfs ---
...
if all(ax~=[0 1 0 1]), zoom(gca,'reset'); axis(ax); end    % rfs
