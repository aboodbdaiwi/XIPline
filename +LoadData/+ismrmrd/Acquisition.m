classdef Acquisition < handle
    ...
    methods
        ...
        function obj = Acquisition(arg1, traj, data)
            switch nargin
                ...
                case 1
                    ...
                    if LoadData.ismrmrd.util.isInt(arg1)
                    ...
                    elseif isa(arg1,'ismrmrd.AcquisitionHeader')
                        ...
                        obj.head = LoadData.ismrmrd.AcquisitionHeader(arg1);
                        obj.initializeData();
                    end
        ...
        function acq = select(obj, range)
            ...
            acq = LoadData.ismrmrd.Acquisition();
            % Fill the header
        ...
        function extend(obj,N)
            ...
            if isempty(obj.head)
                M = N;
                obj.head = LoadData.ismrmrd.AcquisitionHeader(N);
            else
                M = N+obj.getNumber();
                obj.head.extend(N);
            end
