# -*- coding: utf-8 -*-
"""
CCHMC Python functions for son-of-host reconstruction
3/2026
...
def setup_mcr(versions = [],what='fidall'):
  ...
  for ver in versions:
    ...
    mascri1 = dir(what) + 'bin/mascri' + str(ver) + '_cchmc/matlab_scripter'
    print(mascri1)
...
def copy_mcr(versions = [242,912,98,95,81]):
  ...
  for ver in versions:
    print('Trying mcr version = ' + str(ver))
    mascri = dir('fidall') + 'bin/mascri' + str(ver) + '_cchmc/matlab_scripter'
    print(mascri)
