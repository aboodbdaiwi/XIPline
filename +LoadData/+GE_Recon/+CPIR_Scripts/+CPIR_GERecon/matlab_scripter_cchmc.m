function matlab_scripter_cchmc(varargin)
...
if dummy_false
    ...
    dcm2readme;
    %cchmc
    recon_nutation;recon_grid_interp;recon_grid3d_gx;
    recon_calibration_cchmc;recon_cart_diffusion;
    NMR_TimeFit; NMR_TimeFit_v; NMR_Fit; NMR_Fit_v; NMR_Mix; NMR_Mix_v;
    write_dicom_cchmc; recon_csi_cchmc;
end
