function Proton = GE_Proton_2D_Spiral_Recon(MainInput)

% GE_Proton_2D_Spiral_Recon
% Reconstruct GE 2D Spiral proton data for XIPline.
%
% Input:
...
if ~isfield(MainInput,'XeFullPath') || isempty(MainInput.HFullPath)
...
fprintf('\n============================================================\n');
fprintf('GE Proton 2D Spiral Reconstruction\n');
fprintf('============================================================\n');
fprintf('Data file:\n%s\n',d);
...
fprintf('\nReconstructing GE 2D Spiral proton data...\n');
...
fprintf('GE 2D Spiral proton reconstruction completed.\n');
...
Proton.ImageCombined = ImageCombined;
