function Ventilation = GE_Vent_3D_FLORET_Recon(MainInput)

% GE_Vent_3D_FLORET_Recon
% Reconstruct GE 3D FLORET hyperpolarized 129Xe ventilation data for XIPline.
%
% Input:
...
fprintf('\n============================================================\n');
fprintf('GE 129Xe 3D FLORET Ventilation Reconstruction\n');
fprintf('============================================================\n');
fprintf('Data file:\n%s\n',d);
...
fprintf('\nReconstructing GE 3D FLORET ventilation data...\n');
...
fprintf('GE 3D FLORET ventilation reconstruction completed.\n');
