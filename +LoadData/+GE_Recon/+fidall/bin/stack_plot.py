...
if len(sys.argv)>6:
  ...
  fnlog = topdir + 'log/' + now.strftime("%Y%m%d_%H%M%S") + '_stack_plot.txt'
...
cmd = ['stack_plot',datadir + rawdataname,'[]',lb,'[]',datadir + rawdataname]
if dofifo:
  sor.run_fifo(cmd)
