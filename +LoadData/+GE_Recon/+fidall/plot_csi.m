function plot_csi(spec,pc,scale,figstr,fname,method,h,t_comb)
...
%    t_comb   Mean over time                                         (true)
%
% 12/2021 Rolf Schulte
...
for l5=1:nt
    ...
    for l4=1:n4
        ...
        drawnow;
        if ~isempty(fname)
            print(sprintf('%s_sl%g_ts%g',fname,l4,l5),'-dpng','-r300','-painters');
