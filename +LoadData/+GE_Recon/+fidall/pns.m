...
%alternatively:
%  pns(grad,coil)
%      coil  XRM,XRMW,WHOLE,ZOOM,HRMW,HRMB,MAGNUS
%
...
% Premier  HRMW            642.4d-6  17.9     0.310  70     150
% 7T       HRMB            359d-6    26.5     0.370  100    200
% Magnus   MAGNUS          611d-6    52.2     0.324  200    500
%
...
if ischar(chronaxie)
    switch lower(chronaxie)
        case {'xrm','mr750'},   chronaxie=334d-6; rheobase=23.4; alpha=0.333;
        case {'xrmw','mr750w'}, chronaxie=360d-6; rheobase=20.0; alpha=0.324;
        ...
        case 'magnus',chronaxie=611d-6; rheobase=52.2; alpha=0.324;
...
if plt>0
    ...
    figure(13); 
    clf;
    rsos_grad = sqrt(sum(grad(:,:,lp).^2,1));
