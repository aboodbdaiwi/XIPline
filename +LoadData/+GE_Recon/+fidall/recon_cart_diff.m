function [bb,bbabs] = recon_cart_diff(d,h,wfn,zf,delay,lb,fname,comb_time,grdwrp,plt)
...
clear dtmp;
dd = reshape(dd,[nk_freq nk_pha1 nk_pha2 nrep nbvalues ncoils]);
...
if (plt(1)>0) || ~isempty(fname)
    ...
    switch dim
        case 2
                bbplt = reshape(squeeze(bbabs),[size(bbabs,1),size(bbabs,2),n3,nbvalues]);
