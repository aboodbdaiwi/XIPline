function [snr,lw,sz,dur,mdcf,psf_vol] = analyze_mrsi(wfn,lb,...
    zf_fac,verb,fwhi,fov)
%ANALYSE_MRSI  Determine real resolution and SNR of given trajectory
%[snr,lw,sz,dur,mdcf,psf_vol] = analyse_mrsi(wfn,lb,zf_fac,...
%                                 verb,fwhi,fov)
...
%
%  2/2025 Matt Willmering based on Rolf Schulte
