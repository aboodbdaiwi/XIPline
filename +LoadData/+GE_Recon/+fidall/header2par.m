...
par.nucleus = num2str(h.image.specnuc);
if isempty(par.nucleus), warning('isempty(par.nucleus)'); end
...
if (strcmpi(h.image.psd_iname,'jpress') &&  h.image.user24==1) || ...
        (~isempty(regexpi(h.image.psdname,'slaser','once')) && (h.rdb_hdr.user41==1))
