function [Proton, MainInput] = philips_Hanat_3DFLORET_recon(MainInput, Proton)
...
%   Proton - Struct with loaded image and metadata
    ...
    exePath = fullfile(XIPlineRoot, 'offline_recon\Philips_3D_proton_FLORET_recon.exe');
    ...
    outputFile = fullfile(MainInput.HDataLocation, 'img_proton_nufft.nii.gz');
    ...
    Proton.Image    = A;
    Proton.filename = 'img_proton_nufft.nii.gz';
