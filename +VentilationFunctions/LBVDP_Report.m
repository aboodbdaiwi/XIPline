...
function LBVDP_Report(Ventilation, Proton, MainInput)
    ...
    settings = {MainInput.Scanner,MainInput.ScannerSoftware,MainInput.SequenceType,MainInput.Recon,MainInput.AnalysisCode_hash,MainInput.denoiseXe,N4bias,Ventilation.LB_Normalization,Ventilation.HealthyRef.AgeCorrected,todayStr, MainInput.Analyst};
    % Header row
    ...
    figVDP = makeTwoRowMontage(Ventilation.Ventcolormap, 'VDP Map');
    ...
    Venthist = imread([pptDir,'\', char(foldername) ,'LB_Ventilation_Histogram.png']);    
