...
[temp_handles,lobe_label_values] = VentilationFunctions.Akmeans.identify_lobes(temp_handles);
...
for n_ind=1:length(slice_range)
    ...
    for n_lobe=1:numel(lobe_list)
        ...
        if sum(slice_mask(:))>0
            ...
            lobe_contours = VentilationFunctions.Akmeans.mask2poly(slice_mask,'Exact','CW');
