...
switch offset
    case 1
        % 0 degree
        oneGLRLM = VentilationFunctions.rle_0(si,nl);
    case 2
        % 45 degree
        seq = VentilationFunctions.zigzag(si);
        oneGLRLM  = VentilationFunctions.rle_45(seq,nl);
    case 3
        % 90 degree
        oneGLRLM = VentilationFunctions.rle_0(si',nl);
    case 4
        % 135 degree
        seq = VentilationFunctions.zigzag(fliplr(si));
        oneGLRLM = VentilationFunctions.rle_45(seq,nl);
    otherwise
...
% Check I
I = varargin{1};
% validatestring(I,{'logical','numeric'},{'2d','real','nonsparse'}, ...
%     mfilename,'I',1);
% ------------------------
% Assign Defaults
% -------------------------
...
%         inputStr = iptcheckstrs(param, paramStrings, mfilename, 'PARAM', k);
        ...
        switch (inputStr)
            ...
            case 'Offset'
                ...
                offset = varargin{idx};
%                 validatestring(offset,{'logical','numeric'},...
...
%                     mfilename, 'OFFSET', idx);
            ...
            case 'NumLevels'
                ...
                nl = varargin{idx};
%                 validatestring(nl,{'logical','numeric'},...
...
%                     mfilename, 'NL', idx);
            ...
            case 'GrayLimits'
                ...
                gl = varargin{idx};
%                 validatestring(gl,{'logical','numeric'},{'vector','real'},...
%                     mfilename, 'GL', idx);
                if isempty(gl)
                    gl = [min(I(:)) max(I(:))];
                elseif numel(gl) ~= 2
