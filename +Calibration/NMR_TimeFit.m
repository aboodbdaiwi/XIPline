...
classdef NMR_TimeFit < Calibration.NMR_Fit
    methods
        ...
        function [fit_area, fit_freq, fit_fwhm, fit_phase, ci_area, ...
            ...
            largestPeakFit = Calibration.NMR_TimeFit(residualTimeDomainSignal, obj.t, ...
        ...
        function copyObj = copyFitObject(obj)
            ...
            % Create object
            copyObj = Calibration.NMR_TimeFit(timeSig, obj.t, ...
...
%             fun = @(x,xdata)[real(x(1)*exp(1i*pi/180*x(2) - pi*xdata*x(3) + 1i*2*pi*xdata*x(4))), imag(x(1)*exp(1i*pi/180*x(2) - pi*xdata*x(3) + 1i*2*pi*xdata*x(4)))];
% fit = lsqcurvefit(fun,guess,obj.t,...
%                 [real(obj.timeDomainSignal),imag(obj.timeDomainSignal)],...
%                 obj.lb,obj.ub,fitoptions);
% 
%                                     [fit_params,resnorm,residual,exitflag,output,lambda,J] = lsqcurvefit(fun,guess,obj.t,...
%                 [real(obj.timeDomainSignal),imag(obj.timeDomainSignal)],...
%                 obj.lb,obj.ub,fitoptions);
% 
% plot(obj.t,real(obj.timeDomainSignal),'bo',obj.t,imag(obj.timeDomainSignal),'ro',obj.t,fun(fit,obj.t),'b-')
        ...
        function realImagSig = calcConstrainedTimeSig(obj,nmr_params,t)
            ...
            tmpNmrMix = Calibration.NMR_Mix(nmr_params(1,:), nmr_params(2,:), ...
