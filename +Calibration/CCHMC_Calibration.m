function [GasExResults, CalResults] = CCHMC_Calibration(MainInput)
...
te = 120; %in us - TE used in Dissolved Phase flip cal sequence

% % XeCTC-CCHMC Parameters 
% freq = 2463;
