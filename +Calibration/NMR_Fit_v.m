...
%
classdef NMR_Fit_v < Calibration.NMR_Mix_v
    ...
    methods
        function obj = applyGlobalPhaseShift(obj, phaseShiftInDegrees)
            ...
            obj = applyGlobalPhaseShift@Calibration.NMR_Mix_v(obj,phaseShiftInDegrees);
        ...
        function obj = NMR_Fit_v(time_domain_signal, t, ...
            ...
            obj = obj@Calibration.NMR_Mix_v(area,freq,fwhm,fwhmG,phase);
