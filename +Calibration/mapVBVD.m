...
for s=1:NScans
    ...
    rstraj = [];
    if arg.bReadHeader
        [twix_obj{s}.hdr,rstraj] = Calibration.read_twix_hdr(fid);
    end

    % declare data objects:
    twix_obj{s}.image         = Calibration.twix_map_obj(arg,'image',filename,version,rstraj);
    twix_obj{s}.noise         = Calibration.twix_map_obj(arg,'noise',filename,version);
    twix_obj{s}.phasecor      = Calibration.twix_map_obj(arg,'phasecor',filename,version,rstraj);
    twix_obj{s}.phasestab     = Calibration.twix_map_obj(arg,'phasestab',filename,version,rstraj);
    twix_obj{s}.phasestabRef0 = Calibration.twix_map_obj(arg,'phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.phasestabRef1 = Calibration.twix_map_obj(arg,'phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.refscan       = Calibration.twix_map_obj(arg,'refscan',filename,version,rstraj);
    twix_obj{s}.refscanPC     = Calibration.twix_map_obj(arg,'refscan_phasecor',filename,version,rstraj);
    twix_obj{s}.refscanPS     = Calibration.twix_map_obj(arg,'refscan_phasestab',filename,version,rstraj);
    twix_obj{s}.refscanPSRef0 = Calibration.twix_map_obj(arg,'refscan_phasestab_ref0',filename,version,rstraj);
    twix_obj{s}.refscanPSRef1 = Calibration.twix_map_obj(arg,'refscan_phasestab_ref1',filename,version,rstraj);
    twix_obj{s}.RTfeedback    = Calibration.twix_map_obj(arg,'rtfeedback',filename,version,rstraj);
    twix_obj{s}.vop           = Calibration.twix_map_obj(arg,'vop',filename,version); % tx-array rf pulses
