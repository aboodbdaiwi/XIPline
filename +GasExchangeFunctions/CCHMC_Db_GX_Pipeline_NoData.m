...
if ~exist(analysisSubfolder, 'dir')
   ...
   AnalysisDate = str2double(datestr(datetime('today'), 'yyyymmdd'));
    ...
    NewData = {MainInput.SubjectID, MainInput.Age,MainInput.Sex, MainInput.Disease,string(MainInput.ScanDate),'',scan_num,'','', '',MainInput.analysispath,MainInput.Note,'1-Failed', MainInput.Scanner, ...
