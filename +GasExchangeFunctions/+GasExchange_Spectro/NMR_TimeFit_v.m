...
%             fitoptions.Algorithm = 'levenberg-marquardt';
            ...
            [fit_params,resnorm,residual,exitflag,output,lambda,J] = lsqcurvefit(@obj.calcConstrainedTimeSig,double(guess),obj.t,...
                [double(real(obj.timeDomainSignal)),double(imag(obj.timeDomainSignal))],...
