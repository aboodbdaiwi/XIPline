...
%
classdef NMR_Fit < GasExchangeFunctions.GasExchange_Spectro.NMR_Mix
    ...
    methods
        function obj = applyGlobalPhaseShift(obj, phaseShiftInDegrees)
            ...
            obj = applyGlobalPhaseShift@GasExchangeFunctions.GasExchange_Spectro.NMR_Mix(obj,phaseShiftInDegrees);
        ...
        function obj = NMR_Fit(time_domain_signal, t, ...
            ...
            obj = obj@GasExchangeFunctions.GasExchange_Spectro.NMR_Mix(area,freq,fwhm,phase);
