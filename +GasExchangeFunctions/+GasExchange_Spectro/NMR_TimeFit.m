...
%
classdef NMR_TimeFit < GasExchangeFunctions.GasExchange_Spectro.NMR_Fit
    methods
        function obj = NMR_TimeFit(time_domain_signal, t, ...
                area, freq, fwhm, phase, line_broadening, zeroPadSize)
            % Construct an NMR_TimeFit
            obj = obj@GasExchangeFunctions.GasExchange_Spectro.NMR_Fit(time_domain_signal, t, ...
                area, freq, fwhm, phase, line_broadening, zeroPadSize);
        end
        function [fit_area, fit_freq, fit_fwhm, fit_phase, ci_area, ...
            ...
            largestPeakFit = GasExchangeFunctions.GasExchange_Spectro.NMR_TimeFit(residualTimeDomainSignal, obj.t, ...
        ...
        function copyObj = copyFitObject(obj)
            ...
            % Create object
            copyObj = GasExchangeFunctions.GasExchange_Spectro.NMR_TimeFit(timeSig, obj.t, ...
        ...
        function realImagSig = calcConstrainedTimeSig(obj,nmr_params,t)
            ...
            tmpNmrMix = GasExchangeFunctions.GasExchange_Spectro.NMR_Mix(nmr_params(1,:), nmr_params(2,:), ...
