function [biasCorrectedImage, biasField] = Dissolved_ProtonBiasCorrection(Image,Mask)
...
cmd = ['"',N4Path,'N4BiasFieldCorrection.exe"',...%run bias correction
    ...
    ' -c [25x50,0]',... % convergence
    ' -b [56,3]',... % spline settings
    ' -t [0.25,0.1,500]',... % histogram settings
