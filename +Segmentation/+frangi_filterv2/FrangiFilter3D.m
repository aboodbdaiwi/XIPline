...
for i = 1:length(sigmas),
    ...
    [Dxx, Dyy, Dzz, Dxy, Dxz, Dyz] = Segmentation.frangi_filterv2.Hessian3D(I,sigmas(i));
    ...
    if(nargout>2)
        [Lambda1,Lambda2,Lambda3,Vx,Vy,Vz]= Segmentation.frangi_filterv2.eig3volume(Dxx,Dxy,Dxz,Dyy,Dyz,Dzz);
    else
        [Lambda1,Lambda2,Lambda3]= Segmentation.frangi_filterv2.eig3volume(Dxx,Dxy,Dxz,Dyy,Dyz,Dzz);
    end
