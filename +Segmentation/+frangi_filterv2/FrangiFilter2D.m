function [outIm,whatScale,Direction,ALLfiltered] = FrangiFilter2D(I, options)
...
%% modified by W. Zha 2015

defaultoptions = struct('FrangiScaleRange', [1 5], 'FrangiScaleRatio', .5, 'FrangiBetaOne', 0.5, 'FrangiBetaTwo', 15, 'verbose',true,'BlackWhite',true,'sigmas',[]);
...
% set default sigmas; W. Zha@3/16/2015
...
%     end
    %%
    % Make 2D hessian
    [Dxx,Dxy,Dyy] = Segmentation.frangi_filterv2.Hessian2D(I,sigmas(i));
    ...
    [Lambda2,Lambda1,Ix,Iy]= Segmentation.frangi_filterv2.eig2image(Dxx,Dxy,Dyy);
